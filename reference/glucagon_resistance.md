...
Expected units: glucagon and insulin in a consistent molar unit (e.g.
pmol/L), measured at fasting (0 min) and 120 min after a 75 g OGTT. If a
required column is missing, the corresponding index is skipped with a
warning.
